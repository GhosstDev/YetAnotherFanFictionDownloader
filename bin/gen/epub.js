...
module.exports = function(options, _callback) {
    ...
    let promise = new Promise(function(resolve, reject) {
        ...
        content.forEach(function(chapter, index){
            ...
            tocNCXNav += `<navPoint id="content_${index}_item_${index}" playOrder="${index+2}" class="chapter"><navLabel><text>${chapter.title}</text></navLabel><content src="${index}.xhtml" /></navPoint>`;
            tocXHTMLNav += `<li class="table-of-contents"><a href="chap_${index}.xhtml">${chapter.title}</a></li>`;
        });
        ...
        <ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1">
            ...
            <navMap>
                <navPoint id="details" playOrder="0" class="chapter">
                    <navLabel>
                        <text>Details</text>
                    </navLabel>
                ...
                <navPoint id="tc" playOrder="1" class="chapter">
                    <navLabel>
        ...
        <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
            ...
            <dc:rights>Copyright &#x00A9; ${date.getFullYear()} by anonymous</dc:rights>
        ...
        <guide>
            <reference type="text" title="Details" href="details.xhtml" />
        ...
        <body>
            ...
            <h3 align='center'><strong>By:</strong> ${author}</h3><br><br>
            <span>${description}</span><br><br>
            <span><strong>Keywords:</strong> ${keywords}</span><br>
            <span><strong>Converted:</strong> ${date.toUTCString()}</span><br>
            <span><strong>Created:</strong> ${created}</span><br>
            <span><strong>Modified:</strong> ${updated}</span><br>
            <span><strong>Chapters:</strong> ${content.length}</span><br>
            <br>
            <h2 align='center'>Created with YAFFS by GhostDev</h2>
        </body>
        `;
        try {
            ...
            fs.mkdirSync(dir+"/OEBPS/images");
            i.debug("[COMPILE] Downloading Fonts and Styles... ");
            fs.copyFileSync(__dirname+"/../style.css", dir+"/OEBPS/css/style.css");         
            ...
            fs.writeFileSync(dir+"/OEBPS/details.xhtml", detailsXHTML);
